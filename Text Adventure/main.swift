...
var archAngel = (e2attack: 70.0, e2defense: 200.0, health: 100.0)
...
func rakundaDrop () {
    if rakundaCount <= 5 {
    rakundaCount -= 1
        if rakundaCount == 0 && pixie.e1defense <= 50    {
        pixie.e1defense = (pixie.e1defense * 2)
            ...
            print("Attack, Persona, Item")
                    ...
                    if archAngel.health <= 0 {
                        ...
                        endingLoop: while archAngel.health <= 0 {
                            print("You beat the hardest difficulty! Enter your name!")
                            var name = readLine()!
                            sleep(1)
